 ...
 * */
  var 
    ...
    C_TREE_FULL_CHECK_CLASS = 'fa-check-square-o',
    C_TREE_PART_CHECK_CLASS = 'fa-plus-square-o',
  ...
  function configureTreeInstance(pTreeId){
    ...
    // Before instantiation the prototype is extended with a method to read the root node id
  ...
  function refreshCallback(pData, pTreeId){
    ...
    if ($.isEmptyObject(pData.data) || pData.message) {
      ...
      options.tree$.html(`<span class="display_only">${pData.message}</span>`);
